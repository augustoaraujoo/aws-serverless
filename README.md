...
your 1config `serverless config credentials --provider aws --key=YOURkey --secret yourKeySecret`

`serverless config credentials --provider aws --key=YOURkey --secret yourKeySecret -o`
